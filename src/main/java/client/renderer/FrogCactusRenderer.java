...
public class FrogCactusRenderer extends GeoEntityRenderer<FrogEntity> {

    public FrogCactusRenderer(EntityRendererProvider.Context renderManager) {
    ...
    public ResourceLocation getTextureLocation(FrogEntity animatable) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_cactus_entity.png");
    }
