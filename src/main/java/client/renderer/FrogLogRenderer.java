...
public class FrogLogRenderer extends GeoEntityRenderer<FrogEntity> {

    public FrogLogRenderer(EntityRendererProvider.Context renderManager) {
    ...
    public ResourceLocation getTextureLocation(FrogEntity animatable) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_log_entity.png");
    }
