...
public class FrogSandRenderer extends GeoEntityRenderer<FrogEntity> {

    public FrogSandRenderer(EntityRendererProvider.Context renderManager) {
    ...
    public ResourceLocation getTextureLocation(FrogEntity animatable) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_sand_entity.png");
    }
