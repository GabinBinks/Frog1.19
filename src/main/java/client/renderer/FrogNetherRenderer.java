...
public class FrogNetherRenderer extends GeoEntityRenderer<FrogEntity> {

    public FrogNetherRenderer(EntityRendererProvider.Context renderManager) {
    ...
    public ResourceLocation getTextureLocation(FrogEntity animatable) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_nether_entity.png");
    }
