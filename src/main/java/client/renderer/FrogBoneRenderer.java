...
public class FrogBoneRenderer extends GeoEntityRenderer<FrogEntity> {

    public FrogBoneRenderer(EntityRendererProvider.Context renderManager) {
    ...
    public ResourceLocation getTextureLocation(FrogEntity animatable) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_bone_entity.png");
    }
