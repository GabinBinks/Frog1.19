...
public class FrogNetherQuartzModel extends AnimatedGeoModel<FrogEntity> {
    ...
    public ResourceLocation getTextureResource(FrogEntity object) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_nether_quartz_entity");
    }
