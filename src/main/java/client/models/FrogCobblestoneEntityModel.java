...
public class FrogCobblestoneEntityModel extends AnimatedGeoModel<FrogEntity> {
    ...
    public ResourceLocation getTextureResource(FrogEntity object) {
        return new ResourceLocation(Frog.MOD_ID, "textures/entities/frog_cobblestone_entity");
    }
